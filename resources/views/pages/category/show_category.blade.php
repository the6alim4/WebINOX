...
@section('content')		
                ...
                border-radius: 24px;">
					<h2 style="width: 100%;text-align: center;height: 100%;font-size: x-large;font-weight: bold;color: rgb(228, 116, 11)"><i class="fa fa-star-o" aria-hidden="true"></i>&nbsp;{{$tenloai->TenLoai}}&nbsp;<i class="fa fa-star-o" aria-hidden="true"></i></h2>
					<hr class="soften" />
