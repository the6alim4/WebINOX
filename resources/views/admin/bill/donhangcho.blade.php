        ...
        <table class="table table-striped b-t b-light" >
          ...
          <tbody>
            @foreach ($bills as $key ) 
              ...
              <td>{{$key->TongTien}}</td>
              <td>
                <a href="{{URL::to('/detail-bill/'.$key->MaHDB)}}" class="active styling-edit" ui-toggle-class="">
                    <i class="fa fa-info" aria-hidden="true"></i>
                </a>
                <a onclick="return confirm('Bạn có chắc hủy đơn hàng?')" href="{{URL::to('/delete-bill/'.$key->MaHDB)}}" class="active styling-edit" ui-toggle-class="">  
                  <i class="fa fa-times text-danger text"></i>
                </a>
                <a onclick="return confirm('Bạn có chắc xác nhận đơn hàng?')" href="{{URL::to('/confirm-bill/'.$key->MaHDB)}}" class="active styling-edit" ui-toggle-class="">  
