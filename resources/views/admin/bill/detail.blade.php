...
<?php
      ...
      <div class="table-responsive">
          <div>
              ...
              <div>Người đặt hàng:{{$infor->TenNguoiDung}} <strong>(tỉ lệ đơn thất bại:{{$tilebomhang}}%)</strong></div>
        ...
        <div>
            ...
            <div style="display:flex;justify-content: center;align-items: center;">
                <span>
                    <a id="btndt1" style="font-size: 14px;color: black;background: rgb(230, 200, 146);border-radius:5px;" onclick="return confirm('Bạn có chắc hủy đơn hàng?')" href="{{URL::to('/delete-bill/'.$infor->MaHDB)}}" class="active styling-edit" ui-toggle-class="">  
                        Hủy đơn hàng
                    </a>
                    &nbsp;
                    &nbsp;
                    <a id="btndt2" style="font-size: 14px;color: black;background: rgb(230, 200, 146);border-radius:5px;" onclick="return confirm('Bạn có chắc xác nhận đơn hàng?')" href="{{URL::to('/confirm-bill/'.$infor->MaHDB)}}" class="active styling-edit" ui-toggle-class="">  
                        Xác nhận đơn hàng
                    </a>
                </span>
            </div>
