...
<div class="row">
	...
	<a class="logo" href="index.html"><span>Twitter Bootstrap ecommerce template</span> 
		<img src="{{('public/frontend/img/logo-bootstrap-shoping-cart.png')}}" alt="bootstrap sexy shop">
	</a>
	</h1>
	</div>
	<div class="span4">
		...
		<li> <a class="totalInCart" href="cart.html"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;">$448.42</span></strong></a></li>
			...
			<li>
			  <div class="thumbnail">
				...
				<img src="{{('public/frontend/img/bootstrap-ecommerce-templates.png')}}" alt="bootstrap ecommerce templates">
				<div class="caption">
